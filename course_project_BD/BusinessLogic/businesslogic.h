...
public:
    ...
    bool addNewDoc(BaseDoc &doc);
    bool addNewDoc(BirthDoc &doc);
    bool addNewDoc(DeathDoc &doc);
    bool addNewDoc(MarriageDoc &doc);
    bool addNewDoc(ResidenceDoc &doc);
    bool addNewDoc(StudyDoc &doc);
    bool addNewDoc(WorkDoc &doc);
